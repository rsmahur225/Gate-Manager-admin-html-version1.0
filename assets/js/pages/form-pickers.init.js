!(function (t) {
  ...
  (e.prototype.init = function () {
    t("#basic-datepicker").flatpickr(),
      ...
      t("#colorpicker-default, #colorpicker-two, #colorpicker-three, #colorpicker-four, #colorpicker-five, #colorpicker-six, #colorpicker-seven").spectrum(),
