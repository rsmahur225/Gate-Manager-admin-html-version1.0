(easeInOutQuad = function (t, e, n, o) {
          ...
          s("#side-menu a").each(function () {
            ...
            this.href == o &&
              ...
              (n = s(this)
                ...
                .parent()
                .parent()
                .parent()).is("body") || n.addClass("menuitem-active")),
              setTimeout(function () {
                var t,
                  e,
                ...
                null != n &&
                  ...
                  (e = n.offsetTop - 300),
                  t && 100 < e && scrollTo(t, e, 600));
              }, 200);
          })),
        s("#two-col-sidenav-main").length &&
          ((n = s("#two-col-sidenav-main .nav-link")),
          (o = s(".twocolumn-menu-item")),
          (e = s(".twocolumn-menu-item .nav-second-level")),
          (i = s("#two-col-menu li .collapse")).on({
            "show.bs.collapse": function () {
              var t = s(this).closest(e).closest(e).find(i);
              t.length
                ? t.not(s(this)).collapse("hide")
                : i.not(s(this)).collapse("hide");
            },
          }),
          ...
          s("#two-col-menu a").each(function () {
            ...
            this.href == a &&
              ...
              (n = s(this)
                ...
                .parent()).is("body") || n.addClass("menuitem-active"),
              (o = null),
              (i = "#" + s(this).parents(".twocolumn-menu-item").attr("id")),
              s("#two-col-sidenav-main .nav-link").each(function () {
    ...
    (t.prototype.initMenu = function () {
          ...
          this.href == n &&
            ...
            i(this)
              ...
              : (t = i(this)
                ...
                ((n = window.location.href.split(/[?#]/)[0]),
                (t.href != n && !t.classList.contains("dropdown-toggle")) ||
            ...
            (e = i(this)
              ...
              .parent()
              .addClass("active")
              .prev()).hasClass("nav-link") && e.addClass("active"));
        }),
      ...
      t.forEach(function (n) {
        n.addEventListener("click", function (t) {
          var e;
          n.parentElement.classList.contains("nav-item") ||
            ((o = !0),
            n.parentElement.parentElement.classList.add("show"),
            ((e =
  ...
  (function (e) {
    ...
    (t.prototype.toggleRightSideBar = function () {
      ...
      (t.prototype.init = function () {
        ...
        e(document).on("click", ".right-bar-toggle", function () {
          ...
          e(document).on("click", "body", function (t) {
            1 !== e(t.target).closest("#top-search").length &&
              e("#search-dropdown").removeClass("d-block"),
      ...
      (e.RightBar = new t()),
      (e.RightBar.Constructor = t);
  })(window.jQuery),
  (function (t) {
    "use strict";
    function e() {}
    (e.prototype.init = function () {
      (this.leftSidebar = t.LeftSidebar),
        this.leftSidebar.init(),
        (this.topbar = t.Topbar),
        (this.themeCustomizer = t.ThemeCustomizer),
        this.themeCustomizer.init(),
        ((this.leftSidebar.parent = this).topbar.parent = this).topbar.init();
    }),
  ...
  (function (t) {
    ...
    function e() {
      (this.body = document.body),
        (this.defaultConfig = {
          leftbar: { color: "light", size: "default" },
          menu: { position: "fixed" },
          layout: { color: "light", width: "fluid", mode: "default" },
          topbar: { color: "light" },
          sidebar: { user: !0 },
        });
    }
    (e.prototype.initConfig = function () {
      ...
      (t.leftbar.color =
        null != this.body.getAttribute("data-leftbar-color")
          ? this.body.getAttribute("data-leftbar-color")
          : this.defaultConfig.leftbar.color),
        (t.leftbar.size =
          null != this.body.getAttribute("data-leftbar-size")
            ? this.body.getAttribute("data-leftbar-size")
            : this.defaultConfig.leftbar.size),
        (t.menu.position =
          null != this.body.getAttribute("data-leftbar-position")
            ? this.body.getAttribute("data-leftbar-position")
            : this.defaultConfig.menu.position),
        (t.layout.color =
          null != this.body.getAttribute("data-theme")
            ? this.body.getAttribute("data-theme")
            : this.defaultConfig.layout.color),
        (t.layout.width =
          null != this.body.getAttribute("data-layout-width")
            ? this.body.getAttribute("data-layout-width")
            : this.defaultConfig.layout.width),
        (t.layout.mode =
          null != this.body.getAttribute("data-layout-mode")
            ? this.body.getAttribute("data-layout-mode")
            : this.defaultConfig.layout.mode),
        (t.topbar.color =
          null != this.body.getAttribute("data-topbar-color")
            ? this.body.getAttribute("data-topbar-color")
            : this.defaultConfig.topbar.color),
        (t.sidebar.user =
          null != this.body.getAttribute("data-sidebar-user")
            ? this.body.getAttribute("data-sidebar-user")
            : this.defaultConfig.sidebar.user),
        (this.defaultConfig = JSON.parse(JSON.stringify(t))),
        (this.config = t),
      ...
      (e.prototype.changeMenuPosition = function (t) {
        (this.config.menu.position = t),
          this.body.setAttribute("data-menu-position", t),
          this.setSwitchFromConfig();
      }),
      (e.prototype.changeLeftbarSize = function (t) {
        "topnav" !== this.config.layout.mode &&
      ...
      (e.prototype.changeLayoutColor = function (t) {
        (this.config.layout.color = t),
          this.body.setAttribute("data-theme", t),
          this.setSwitchFromConfig();
      }),
      (e.prototype.changeLayoutWidth = function (t) {
        (this.config.layout.width = t),
          this.body.setAttribute("data-layout-width", t),
          "boxed" == t
      ...
      (e.prototype.initSwitchListener = function () {
        ...
        document
          ...
          document
            .querySelectorAll("input[name=menu-position]")
            .forEach(function (e) {
              e.addEventListener("change", function (t) {
          ...
          document
            .querySelectorAll("input[name=layout-width]")
            .forEach(function (e) {
              e.addEventListener("change", function (t) {
          ...
          document.querySelector(".button-menu-mobile") &&
            document
              ...
              .addEventListener("click", function () {
                "default" === n.config.leftbar.size
                  ? n.changeLeftbarSize("condensed")
                  : n.changeLeftbarSize("default");
              });
      }),
      (e.prototype.initWindowSize = function () {
        var e = this;
        window.addEventListener("resize", function (t) {
          750 <= window.innerWidth && window.innerWidth <= 1028
            ? e.changeLeftbarSize("condensed")
            : e.changeLeftbarSize("default");
        });
      }),
      (e.prototype.setSwitchFromConfig = function () {
        ...
        l &&
          ...
          (n = document.querySelector(
            "input[type=checkbox][name=menu-position][value=" +
              l.menu.position +
              "]"
          )),
          ...
          (i = document.querySelector(
            "input[type=checkbox][name=layout-width][value=" +
              l.layout.width +
              "]"
          )),
      ...
      (t.ThemeCustomizer = new e()),
      (t.ThemeCustomizer.Constructor = e);
  })(window.jQuery),
  (function (a) {
    "use strict";
    function t() {}
    (t.prototype.initTooltipPlugin = function () {
      ...
      (t.prototype.initCounterUp = function () {
        var n = a(this).attr("data-delay") ? a(this).attr("data-delay") : 100,
          o = a(this).attr("data-time") ? a(this).attr("data-time") : 1200;
        a('[data-plugin="counterup"]').each(function (t, e) {
          a(this).counterUp({ delay: n, time: o });
        });
      }),
      (t.prototype.initPeityCharts = function () {
        a('[data-plugin="peity-pie"]').each(function (t, e) {
          var n = a(this).attr("data-colors")
              ? a(this).attr("data-colors").split(",")
              : [],
            o = a(this).attr("data-width") ? a(this).attr("data-width") : 20,
            i = a(this).attr("data-height") ? a(this).attr("data-height") : 20;
          a(this).peity("pie", { fill: n, width: o, height: i });
        }),
          a('[data-plugin="peity-donut"]').each(function (t, e) {
            var n = a(this).attr("data-colors")
                ...
                : [],
              o = a(this).attr("data-width") ? a(this).attr("data-width") : 20,
              i = a(this).attr("data-height")
                ? a(this).attr("data-height")
                : 20;
            a(this).peity("donut", { fill: n, width: o, height: i });
          }),
          ...
          a('[data-plugin="peity-bar"]').each(function (t, e) {
            var n = a(this).attr("data-colors")
              ...
              i = a(this).attr("data-height")
                ? a(this).attr("data-height")
                : 20;
            a(this).peity("bar", { fill: n, width: o, height: i });
          });
      }),
    ...
    (t.prototype.initControls = function () {
      ...
      (t.prototype.init = function () {
        n.Portlet.init(),
          n.Components.init(),
          this.initControls(),
          (this.layout = n.LayoutThemeApp),
          (this.rightBar = n.RightBar),
